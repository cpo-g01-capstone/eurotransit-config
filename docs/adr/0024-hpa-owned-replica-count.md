# ADR 0024 — HPA-managed Deployments omit `spec.replicas` (the HPA owns the replica count)
...
- [ ] `docs/agent-log.md` Case 15 recorded (the original agent omission)
